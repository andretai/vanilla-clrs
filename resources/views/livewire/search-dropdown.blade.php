<div class="px-6 relative">
    <div>
        <input type="text" wire:model="query" wire:keydown.escape="resetValues" wire:keydown.tab="resetValues" class="bg-gray-200 text pt-2 w-64 px-4 pl-8 py-1 focus:outline-none focus:shadow-outline" placeholder="Click to Search Courses..." />
    </div>
